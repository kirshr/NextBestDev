function BioTopic({ topic }) {
  return (
    <article className="py-2 px-5">
      <h2 className="text-base font-semibold tracking-tight text-amber-300">
        {topic}
      </h2>
      <p className=" mt-2 text-md text-cyan-50 dark:text-zinc-400">
      ...
      <footer className="my-4 flex items-center text-sm font-medium text-cyan-50">
        <h3>read more</h3>
      </footer>
    </article>
  );
