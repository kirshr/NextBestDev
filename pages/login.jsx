...
function LoginPage() {
  return (
    <>
      <aside className="py-10 px-2">
        <header className="sm:mx-auto sm:w-full sm:max-w-md ">
          <SvgLogo className="fill-amber-300 h-12 mx-auto" />
          <h1 className="mt-6 text-center text-3xl font-bold tracking-tight text-amber-300">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <a
              href="#"
              className="font-medium text-cyan-50 hover:text-amber-500"
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-gray-300 text-cyan-50 focus:ring-indigo-500"
                  />
                  <label
                    htmlFor="remember-me"
                ...
                <div className="text-sm">
                  <a
                    href="#"
                    className="font-medium text-cyan-50 hover:text-indigo-500"
                  >
